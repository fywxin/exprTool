...
public class ForExpr extends BodyExpr {
    ...
    public ForExpr(String text, Integer startLine, Integer startCol, Integer bodyStartCol) {
    ...
    public ForExpr finish(Integer stopLine, Integer stopCol, Integer bodyStopCol) {
